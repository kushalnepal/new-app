    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-gray-200 py-12 px-4">
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-4xl">
        ...
        <div className="mb-8 p-6 bg-gray-700 rounded-lg shadow-md">
          <h2 className="text-2xl font-medium mb-4">Add Transaction</h2>
          <Formik
            initialValues={{ type: 'income', description: '', amount: 0 }}
            ...
            <tbody>
              {transactions.map((transaction, index) => (
                <tr key={index} className="border-b border-gray-600">
                  ...
                  <td className={`px-4 py-2 ${transaction.type === 'expense' ? 'text-red-500' : 'text-gray-300'}`}>
                    ${transaction.amount}
                  </td>
